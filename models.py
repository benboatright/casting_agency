...
def setup_db(app,uri):
    ...
    db.app = app
    db.init_app(app)
    migrate = Migrate(app,db) #9/11/22 #followed this video to setup migrations #https://learn.udacity.com/nanodegrees/nd0044/parts/cd0046/lessons/e01a0ac9-68dd-4844-b399-b8fa3be667e0/concepts/a1a5f8a9-37de-48e3-906c-3279599175b8
